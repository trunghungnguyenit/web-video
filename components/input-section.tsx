    ...
    <section className="space-y-6">
      <div>
        <h2 className="text-xs font-bold text-primary uppercase tracking-widest mb-6">
          1. NHẬP NỘI DUNG ĐỂ AI TẠO VIDEO
        </h2>
        ...
        <div className="grid grid-cols-4 gap-4 mb-6">
          {['Ngôn ngữ', 'Độ dài video', 'Kiểu video', 'Giọng đọc'].map((label, idx) => (
            <div key={idx}>
              <label className="text-xs font-semibold text-muted-foreground block mb-2">{label}</label>
